...
# 
# #PW PRO CLICKS
# DANCb2015_con <- read.csv(paste0(dir, 'Consensus_data/PW_Pro_clicks/DANCb2015_classifications.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/DANCb2015/')
# output_dir <- paste0(dir, 'QC_images/DANCb2015/')
# 
# 
# # Run function
# pt_img_fun(nest_coords = DANCb2015_v1_nc,
#            consensus = DANCb2015_con,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(2048, 1536),
#            poly_tr = 0.6,
...
# 
# #PW PRO CLICKS
# NEKOc2014_con <- read.csv(paste0(dir, 'Consensus_data/PW_Pro_clicks/NEKOc2014_classifications.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/NEKOc2014/')
# output_dir <- paste0(dir, 'QC_images/NEKOc2014/')
# 
# 
# # Run function
# pt_img_fun(nest_coords = NEKOc2014_nc,
#            consensus = NEKOc2014_con,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(2048, 1536),
#            poly_tr = 0.6,
...
# 
# #PW PRO CLICKS
# NEKOc2015_con <- read.csv(paste0(dir, 'Consensus_data/PW_Pro_clicks/NEKOc2015_classifications.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/NEKOc2015/')
# output_dir <- paste0(dir, 'QC_images/NEKOc2015/')
# 
# 
# # Run function
# pt_img_fun(nest_coords = NEKOc2015_nc,
#            consensus = NEKOc2015_con,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(2048, 1536),
#            poly_tr = 0.6,
...
# 
# #PW PRO CLICKS
# NEKOc2016_con <- read.csv(paste0(dir, 'Consensus_data/PW_Pro_clicks/NEKOc2016_classifications.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/NEKOc2016/')
# output_dir <- paste0(dir, 'QC_images/NEKOc2016/')
# 
# 
# # Run function
# pt_img_fun(nest_coords = NEKOc2016_nc,
#            consensus = NEKOc2016_con,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(2048, 1536),
#            poly_tr = 0.6,
...
# 
# #PW PRO CLICKS
# OCEAa2015_con <- read.csv(paste0(dir, 'Consensus_data/PW_Pro_clicks/OCEAa2015_classifications.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/OCEAa2015/')
# output_dir <- paste0(dir, 'QC_images/OCEAa2015/')
# 
# 
# # Run function
# pt_img_fun(nest_coords = OCEAa2015_nc,
#            consensus = OCEAa2015_con,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(2048, 1536),
#            poly_tr = 0.6,
...
# 
# #PW PRO CLICKS
# GODHb2018_con <- read.csv(paste0(dir, 'Consensus_data/PW_Pro_clicks/GODHb2018_classifications.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/GODHb2018/')
# output_dir <- paste0(dir, 'QC_images/GODHb2018/')
# 
# 
# # Run function
# pt_img_fun(nest_coords = GODHb2018_nc,
#            consensus = GODHb2018_con,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(2048, 1536),
#            poly_tr = 0.6,
...
# 
# #PW PRO CLICKS
# JOUGa2017_con <- read.csv(paste0(dir, 'Consensus_data/PW_Pro_clicks/JOUGa2017_classifications.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/JOUGa2017/')
# output_dir <- paste0(dir, 'QC_images/JOUGa2017/')
# 
# 
# # Run function
# pt_img_fun(nest_coords = JOUGa2017_v1_nc,
#            consensus = JOUGa2017_con,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(2048, 1536),
#            poly_tr = 0.6,
...
# 
# #PW PRO CLICKS
# MIKKa2017_con <- read.csv(paste0(dir, 'Consensus_data/PW_Pro_clicks/MIKKa2017_classifications.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/MIKKa2017/')
# output_dir <- paste0(dir, 'QC_images/MIKKa2017/')
# 
# 
# # Run function
# pt_img_fun(nest_coords = MIKKa2017_nc,
#            consensus = MIKKa2017_con,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(2048, 1536),
#            poly_tr = 0.6,
...
# #NEST COORDINATES
# MIKKa2018_nc <- read.csv(paste0(dir, 'Nest_coords/MIKKa2018_nestcoords.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/MIKKa2018/')
# output_dir <- paste0(dir, 'Images_with_polys/MIKKa2018/')
# 
# # Run function
# pt_img_fun(nest_coords = MIKKa2018_nc,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(1920, 1080),
#            poly_tr = 0.9,
...
# 
# #PW PRO CLICKS
# MIKKa2018_con <- read.csv(paste0(dir, 'Consensus_data/PW_Pro_clicks/MIKKa2018_classifications.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/MIKKa2018/')
# output_dir <- paste0(dir, 'QC_images/MIKKa2018/')
# 
# 
# # Run function
# pt_img_fun(nest_coords = MIKKa2018_nc,
#            consensus = MIKKa2018_con,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(1920, 1080),
#            poly_tr = 0.6,
...
# #NEST COORDINATES
# BROWc2018_nc <- read.csv(paste0(dir, 'Nest_coords/BROWc2018_nestcoords.csv'))
# 
# # set input/output
# jpeg_dir <- paste0(dir, 'Full_res_images/BROWc2018/')
# output_dir <- paste0(dir, 'Images_with_polys/BROWc2018/')
# 
# # Run function
# pt_img_fun(nest_coords = BROWc2018_nc,
#            jpeg_dir = jpeg_dir,
#            output_dir = output_dir,
#            dim = c(2048, 1536),
#            poly_tr = 0.9,
...
# output_dir <- paste0(dir, 'Images_with_polys/BROWa2016/')
# 
# # Run function
